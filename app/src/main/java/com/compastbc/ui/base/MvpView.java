...
public interface MvpView {
    ...
    void getAccessToken(String userName, String pwd, BaseActivity.TokenCallback tokenCallback);

    void getAccessToken(BaseActivity.TokenCallback tokenCallback);

    void downloadMasterData(BaseActivity.DownloadDataCallback downloadDataCallback);
