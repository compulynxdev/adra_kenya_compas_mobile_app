                        ...
                        public void onResponse(@NonNull Call<ResponseBody> call, @NonNull Response<ResponseBody> response) {
                            if (response.code() == 200) {
                                try {
                                    ...
                                    if (fingers.length() > 0) {
                                        if (fingers.getString("leftFinger3B64") != null)
                                            fps.add(fingers.getString("leftFinger3B64"));

                                        if (fingers.getString("rightFinger3B64") != null)
                                            fps.add(fingers.getString("rightFinger3B64"));

                                        if (fingers.getString("rightFinger2B64") != null)
                                            fps.add(fingers.getString("rightFinger2B64"));

                                        if (fingers.getString("leftFinger2B64") != null)
                                            fps.add(fingers.getString("leftFinger2B64"));

                                        if (fingers.getString("leftFinger1B64") != null)
                                            fps.add(fingers.getString("leftFinger1B64"));

                                        if (fingers.getString("leftIndexB64") != null)
                                            fps.add(fingers.getString("leftIndexB64"));

                                        if (fingers.getString("rightFinger1B64") != null)
                                            fps.add(fingers.getString("rightFinger1B64"));

                                        if (fingers.getString("rightThumbB64") != null)
                                            fps.add(fingers.getString("rightThumbB64"));

                                        if (fingers.getString("rightIndexB64") != null)
                                            fps.add(fingers.getString("rightIndexB64"));

                                        if (fingers.getString("leftThumbB64") != null)
