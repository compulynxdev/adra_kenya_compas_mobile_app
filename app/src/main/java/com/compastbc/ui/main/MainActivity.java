...
import com.compastbc.ui.transaction.TransactionActivity;
...
import com.compastbc.utils.PermissionUtils;
...
//                    nfcReader.onNfcStatusListener("CardTxn", this);
                    Intent tIntent= TransactionActivity.getStartIntent(getActivity());
                ...
                case AppConstants.BENEFICIARY_VIEW:
                    ...
                    intent = BeneficiaryActivity.getStartIntent(this);
                    startActivity(intent);*/
                    createLog(TAG, "Beneficiary List");
                    startActivity(BeneficiaryListActivity.getStartIntent(this));
                    break;
