...
public class SynchronisationActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void deleteOldFile() {
        File pathVendorData = new File(this.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS)+
        ...
        File pathAckData = new File(this.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS)+
