...
import com.compastbc.data.db.model.SyncLogs;
import com.compastbc.data.db.model.SyncLogsDao;
...
import com.compastbc.data.network.model.PendingSync;
...
import com.compastbc.ui.synchronization.transfer.TransferService;
...
public class ReceiveActivity extends BaseActivity {
    ...
    BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            final File path = new File(context.getExternalFilesDir("/") +
                    File.separator.concat(AppConstants.FOLDER_NAME).concat("/").concat(AppConstants.FILE_NAME));

            File pathAck = new File(context.getExternalFilesDir("/") +
    ...
    private void deleteOldFile() {
        File pathVendorData = new File(this.getExternalFilesDir("/") +
                File.separator.concat(AppConstants.FOLDER_NAME).concat("/").concat(AppConstants.FILE_NAME));
        if (pathVendorData.exists()) AppUtils.deleteFile(pathVendorData);

        File pathAckData = new File(this.getExternalFilesDir("/") +
                File.separator.concat(AppConstants.FOLDER_NAME).concat("/").concat(AppConstants.ACK_FILE_NAME));
