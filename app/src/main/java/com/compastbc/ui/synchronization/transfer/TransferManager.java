...
import com.compastbc.ui.synchronization.bundle.Item;
...
public class TransferManager {
    ...
    public static final String TRANSFER_UPDATED = "com.edisbursement.compas.ui.logo.synchronization.TRANSFER_UPDATED";
    public static final String EXTRA_STATUS = "com.edisbursement.compas.ui.logo.synchronization.STATUS";
    ...
    TransferManager(Context context, TransferNotificationManager transferNotificationManager) {
        ...
        mMediaScannerConnection = new MediaScannerConnection(mContext, new MediaScannerConnection.MediaScannerConnectionClient() {
            ...
            public void onMediaScannerConnected() {
                AppLogger.i(TAG, "connected to media scanner");
            }
