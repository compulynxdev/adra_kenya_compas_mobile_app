...
import com.compastbc.data.db.model.PurchasedProductsDao;
...
import com.compastbc.data.db.model.TxnCountDao;
    ...
    public void saveData() {
        ...
        if (getDataManager().getConfigurableParameterDetail().isOnline()) {
          ...
          /*  com.compastbc.data.db.model.Topups tps = getDataManager().getDaoSession().getTopupsDao().queryBuilder().where(TopupsDao.Properties.ProgrammeId.eq(topups.getProgrammeid()),
            ...
            com.compastbc.data.db.model.Topups tps = getDataManager().getDaoSession().getTopupsDao().queryBuilder()
            ...
            com.compastbc.data.db.model.Topups topups1 = getDataManager().getDaoSession().getTopupsDao().queryBuilder().where(TopupsDao.Properties.CardNumber.eq(topups.getCardnumber()),
