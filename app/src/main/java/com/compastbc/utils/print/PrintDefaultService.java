...
public class PrintDefaultService implements PrinterCallback {
    ...
    private byte[] printFormat = new byte[]{0x1B, 0x21, 0x03};
    ...
    private void printTransactionReceipt(TransactionReceipt receipt, boolean isMac) {
        ...
        printCustom(context.getString(R.string.username).concat(" : ").concat(Compas.getInstance().getDataManager().getUserDetail().getUser()), 0, 0);
        if (isMac)
            printCustom(context.getString(R.string.MacID).concat(" : ").concat(Compas.getInstance().getDataManager().getDeviceId()), 0, 0);
    ...
    private void printHeader(String title) {
        ...
        printNewLine();
        printCustom(context.getString(R.string.username).concat(" : ").concat(Compas.getInstance().getDataManager().getUserDetail().getUser()), 0, 0);
        printCustom(context.getString(R.string.location).concat(" ").concat(Compas.getInstance().getDataManager().getUserDetail().getLocationName()), 0, 0);
        printCustom(context.getString(R.string.MacID).concat(" : ").concat(Compas.getInstance().getDataManager().getDeviceId()), 0, 0);
