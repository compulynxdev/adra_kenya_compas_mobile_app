...
import com.compastbc.data.network.model.ReportModel;
...
public class PrintPosService implements PrinterCallback {
    ...
    private void printTransactionReceipt(TransactionReceipt receipt, boolean isMac) {
        ...
        printCustom(context.getString(R.string.username).concat(" : ").concat(Compas.getInstance().getDataManager().getUserDetail().getUser()), TEXT_SIZE_SMALL, TEXT_ALIGN_LEFT);
        if (isMac)
            printCustom(context.getString(R.string.MacID).concat(" : ").concat(Compas.getInstance().getDataManager().getDeviceId()), TEXT_SIZE_SMALL, TEXT_ALIGN_LEFT);
    ...
    private void printHeader(String title) {
        ...
        printNewLine();
        printCustom(context.getString(R.string.username).concat(" : ").concat(Compas.getInstance().getDataManager().getUserDetail().getUser()), TEXT_SIZE_SMALL, TEXT_ALIGN_LEFT);
        printCustom(context.getString(R.string.location).concat(" ").concat(Compas.getInstance().getDataManager().getUserDetail().getLocationName()), TEXT_SIZE_SMALL, TEXT_ALIGN_LEFT);
        printCustom(context.getString(R.string.MacID).concat(" : ").concat(Compas.getInstance().getDataManager().getDeviceId()), TEXT_SIZE_SMALL, TEXT_ALIGN_LEFT);
